...
public class ma_Game : MonoBehaviour
{
    ...
    public Vector2 previewMinoPosition = new Vector2(-6.5f, 16);
    ...
    public bool CheckIsAboveGrid(ma_Tetromino tetromino)
    {
    ...
    public void UpdateGrid(ma_Tetromino tetromino)
    {
        for (int y = 0; y < gridHeight; ++y)
        {
            for (int x = 0; x < gridWidth; ++x)
    ...
    public void SpawnNextTetromino()
    {
        if (!gameStarted)
        {
            ...
            previewTetromino.GetComponent<ma_Tetromino>().enabled = false;
        ...
        else
        {
            ...
            nextTetromino.GetComponent<ma_Tetromino>().enabled = true;
